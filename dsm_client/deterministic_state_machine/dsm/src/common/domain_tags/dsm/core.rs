...
pub const TAG_RECEIPT_COMMIT: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/receipt-commit");
...
pub const TAG_HASH_DATA: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/hash-data");
pub const TAG_ENTITY_ID: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/entity-id");
pub const TAG_DEVICE_ID: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/device-id");
pub const TAG_DSM_NODE_ID: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/node-id");
pub const TAG_DSM_BYTECOMMIT: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/bytecommit");
pub const TAG_BILATERAL_SESSION: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/bilateral-session");
...
pub const TAG_STATE_HASH: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/state-hash");
...
pub const TAG_FUSED_ANCHOR_STATE_LEAF: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/fused-anchor-state-leaf/v1");
...
pub const TAG_OFFLINE_ALLOCATION_LEAF: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/offline-allocation/v1");
...
pub const TAG_OFFLINE_ALLOCATION_STATE: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/offline-allocation-state/v1");
...
pub const TAG_VAULT_RESERVE_LEAF: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/vault-reserve/v1");
...
pub const TAG_VAULT_RESERVE_STATE: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/vault-reserve-state/v1");
...
pub const TAG_SETTLEMENT_RECEIPT_LEAF: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/settlement-receipt/v1");
...
pub const TAG_SETTLEMENT_RECEIPT_STATE: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/settlement-receipt-state/v1");
...
pub const TAG_SETTLEMENT_RECEIPT_SIGN: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/settlement-receipt-sign");
...
pub const TAG_SETTLEMENT_RECEIPT_COMMIT: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/settlement-receipt-commit/v1");
...
pub const TAG_SETTLEMENT_RECEIPT_ID: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/settlement-receipt-id/v1");
...
pub const TAG_VAULT_RESERVE_INCLUSION: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/vault-reserve-inclusion/v1");
pub const TAG_COMMITMENT: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/commitment");
pub const TAG_COMMITMENT_OPEN: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/commitment-open");
pub const TAG_COMMITMENT_FIELDS: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/commitment-fields");
pub const TAG_MERKLE_NODE: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/merkle-node");
pub const TAG_MERKLE_LEAF: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/merkle-leaf");
...
pub const TAG_DEV_MERKLE: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/dev-merkle");
pub const TAG_DEV_LEAF: TaggedHashDomain<'static> = TaggedHashDomain::from_static(b"DSM/dev-leaf");
pub const TAG_DEV_EMPTY: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/dev-empty");
/// Canonical padding leaf for odd-count Merkle levels in the Device Tree.
pub const TAG_DEV_PAD: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/dev-tree-pad");
