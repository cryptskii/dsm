...
pub const TAG_DSM_CERT_CHAIN_SK_AEAD: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/cert-chain-sk-aead");
...
pub const TAG_DSM_EK_CERT: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/ek-cert");
pub const TAG_DSM_HASH_MULTIPLE: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/hash-multiple");
...
pub const TAG_DSM_KYBER_COINS_V1: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/kyber-coins/v1");
...
pub const TAG_DSM_KYBER_RECIPIENT_PUB_V1: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/kyber-recipient-pub/v1");
pub const TAG_DSM_KYBER_SS: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/kyber-ss");
pub const TAG_DSM_ML_KEM_KEYGEN_D: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/ml-kem-keygen-d");
pub const TAG_DSM_ML_KEM_KEYGEN_Z: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/ml-kem-keygen-z");
pub const TAG_DSM_ML_KEM_SEED: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/ml-kem-seed");
pub const TAG_DSM_NEXT_ENTROPY: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/next-entropy");
pub const TAG_DSM_SPHINCS_KDF: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/sphincs-kdf");
pub const TAG_DSM_SPHINCS_SEED: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/sphincs-seed");
pub const TAG_DSM_STEP_SALT: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/step-salt");
...
pub const TAG_DSM_SMASTER_V2: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/Smaster/v2");
...
pub const TAG_DSM_DEVICE_SEED_V2: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/device-seed/v2");
...
pub const TAG_DSM_DEVICE_AK_V2: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/device-ak/v2");
...
pub const TAG_DSM_ATTA_V2: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/atta/v2");
...
pub const TAG_DSM_CHAIN_HEAD_AT_REST_V2: TaggedHashDomain<'static> =
    TaggedHashDomain::from_static(b"DSM/chain-head-at-rest/v2");
