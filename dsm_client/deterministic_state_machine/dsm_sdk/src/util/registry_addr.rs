...
mod tests {
    ...
    fn registry_addr_is_deterministic() {
        let device_id = [0x04, 0xFE, 0xBC, 0x97, 0x85, 0xD6, 0xF4, 0x34,
                         0x7D, 0x01, 0xC0, 0xE9, 0xD7, 0x69, 0x48, 0x6C,
                         0x9E, 0x8C, 0xCB, 0x28, 0x0B, 0xF8, 0x7D, 0x1E,
                         0x84, 0x0D, 0x52, 0x90, 0x91, 0x33, 0x2D, 0x2E];
