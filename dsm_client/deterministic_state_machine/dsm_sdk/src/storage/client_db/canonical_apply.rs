...
impl CanonicalApplyRecord {
    ...
    pub fn record_hash(&self) -> [u8; 32] {
        ...
        let mut h = dsm::crypto::blake3::dsm_domain_hasher(
            dsm::crypto::domain::TaggedHashDomain::from_static(b"DSM/canonical-apply-record/v1"),
        );
        h.update(&id);
...
pub fn compute_canonical_apply_id(
    ...
    let mut h = dsm::crypto::blake3::dsm_domain_hasher(
        dsm::crypto::domain::TaggedHashDomain::from_static(b"DSM/canonical-apply-id/v1"),
    );
