...
- Generated: `2026-04-22T01:45:59Z`
- Run ID: `beta3-20260422`
- Commit: `aec619be6971144b03bbae2b874bf10fa540493a`
- Branch: `main`
- Tree State: `dirty`
...
- `    DSM_tiny -> literal=PASS direct=PASS (5 steps, 3.3ms / 1135.5ms)`
- `    DSM_small -> literal=PASS direct=PASS (5 steps, 1.6ms / 2241.0ms)`
- `    DSM_system -> literal=PASS direct=PASS (5 steps, 1.1ms / 1241.6ms)`
- `    Tripwire -> literal=PASS direct=PASS (4 steps, 0.5ms / 0.7ms)`
